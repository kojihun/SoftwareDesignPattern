 ...
 * @author KoJiHun
 */
public class NonCoronaPatient implements Observer {
    ...
    public NonCoronaPatient(Management member, String patientNumber, String patientName, String patientSex, String patientAge, String patientPsnum, String patientAddr, String patientCheck, String patientType, String patientEnter, String patientExit) {
        management = member;
    ...
    public void update(String patientType, String Text) {
        if (patientType.equals("일반환자")) {
            System.out.println("--------------" + patientType + "의 정기 납부일은 2020-06-17입니다.--------------");
