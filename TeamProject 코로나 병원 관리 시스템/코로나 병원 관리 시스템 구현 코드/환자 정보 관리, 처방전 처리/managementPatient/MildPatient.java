 ...
 * @author KoJiHun
 */
public class MildPatient implements Observer {
    ...
    public MildPatient(Management member, String patientNumber, String patientName, String patientSex, String patientAge, String patientPsnum, String patientAddr, String patientCheck, String patientType, String patientEnter, String patientExit) {
    ...
    public void update(String patientType, String Text) {
        if (patientType.equals("경증환자")) {
            System.out.println("--------------" + patientType + "의 정기 납부일은 2020-06-02입니다.--------------");
